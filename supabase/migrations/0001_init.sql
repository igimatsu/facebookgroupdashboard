-- FB Group Manager — baseline schema
-- Sudah pernah dijalankan manual lewat SQL editor. File ini adalah salinan
-- migration-tracked dari supabase/schema.sql, dipakai oleh `supabase db push`
-- di GitHub Action (.github/workflows/supabase-deploy.yml) supaya perubahan
-- schema berikutnya auto-apply saat push ke main. Aman dijalankan ulang
-- karena semua statement pakai `if not exists` / `or replace`.
...
-- ============================================================
-- Helper view: grup eligible (belum lewat cooldown)
-- ============================================================
